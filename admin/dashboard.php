...
// Hitung data
$totalKamar = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM t_kamar"));
$totalReservasi = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM t_reservasi"));
$totalPelanggan = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM t_pelanggan"));
?>
...
<div class="flex min-h-screen relative overflow-x-hidden">
    ...
    <aside id="sidebar" class="w-64 bg-blue-700 text-white fixed md:sticky top-0 bottom-0 left-0 z-50 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col h-screen shadow-xl md:shadow-none">
        ...
        <nav class="mt-6 flex-1 overflow-y-auto">
            <a href="../admin/dashboard.php" class="flex items-center gap-3 px-6 py-3 bg-blue-800 border-l-4 border-white transition">
            ...
            <a href="kamar/index.php" class="flex items-center gap-3 px-6 py-3 hover:bg-blue-600 transition">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-6 h-6">
    ...
    <main class="flex-1 p-4 md:p-8 pt-20 md:pt-8 w-full overflow-hidden">
        ...
        <!-- Statistik -->
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mt-8">

            <div class="bg-white rounded-xl shadow p-5 md:p-6 border border-gray-100">
                <p class="text-gray-500 text-sm md:text-base">Total Kamar</p>
                <h2 class="text-3xl md:text-4xl font-bold text-blue-600 mt-2 md:mt-3">
                    <?= $totalKamar; ?>
                </h2>
            </div>

            <div class="bg-white rounded-xl shadow p-5 md:p-6 border border-gray-100">
                <p class="text-gray-500 text-sm md:text-base">Total Reservasi</p>
                <h2 class="text-3xl md:text-4xl font-bold text-green-600 mt-2 md:mt-3">
                    <?= $totalReservasi; ?>
                </h2>
            </div>

            <div class="bg-white rounded-xl shadow p-5 md:p-6 sm:col-span-2 md:col-span-1 border border-gray-100">
                <p class="text-gray-500 text-sm md:text-base">Total Pelanggan</p>
                <h2 class="text-3xl md:text-4xl font-bold text-purple-600 mt-2 md:mt-3">
                    <?= $totalPelanggan; ?>
                </h2>
            </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-10">
            ...
            <a href="kamar/index.php" class="bg-white rounded-xl shadow p-4 md:p-6 text-center hover:shadow-lg hover:-translate-y-1 border border-gray-50 transition">
                <div class="flex justify-center mb-2 md:mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-10 h-10 md:w-14 md:h-14 text-blue-600">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 10.5h18v7.5H3v-7.5zm3-4.5h4.5v4.5H6V6zm7.5 0H18v4.5h-4.5V6z"/>
                    </svg>
                </div>
                <h3 class="mt-2 md:mt-4 text-sm md:text-xl font-semibold text-gray-800">Kelola Kamar</h3>
            </a>

            <a href="reservasi/index.php" class="bg-white rounded-xl shadow p-4 md:p-6 text-center hover:shadow-lg hover:-translate-y-1 border border-gray-50 transition">
                <div class="flex justify-center mb-2 md:mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-10 h-10 md:w-14 md:h-14 text-blue-600">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 2.25v3m7.5-3v3m-9 3h10.5m-13.5 12h16.5V6.75A2.25 2.25 0 0018 4.5H6A2.25 2.25 0 003.75 6.75V20.25z"/>
                    </svg>
                </div>
                <h3 class="mt-2 md:mt-4 text-sm md:text-xl font-semibold text-gray-800">Reservasi</h3>
            </a>

            <a href="pelanggan/index.php" class="bg-white rounded-xl shadow p-4 md:p-6 text-center hover:shadow-lg hover:-translate-y-1 border border-gray-50 transition">
                <div class="flex justify-center mb-2 md:mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-10 h-10 md:w-14 md:h-14 text-blue-600">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.964 0A9 9 0 1112 3a9 9 0 015.982 15.725zM15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                </div>
                <h3 class="mt-2 md:mt-4 text-sm md:text-xl font-semibold text-gray-800">Pelanggan</h3>
            </a>

            <a href="../logout.php" class="bg-white rounded-xl shadow p-4 md:p-6 text-center hover:shadow-lg hover:-translate-y-1 border border-gray-50 transition">
                <div class="flex justify-center mb-2 md:mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-10 h-10 md:w-14 md:h-14 text-red-600">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6A2.25 2.25 0 005.25 5.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m-6-3h10.5m0 0l-3-3m3 3l-3 3"/>
                    </svg>
                </div>
                <h3 class="mt-2 md:mt-4 text-sm md:text-xl font-semibold text-gray-800">Logout</h3>
            </a>
